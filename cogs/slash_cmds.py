...
LIBRARIES = ("disnake", "nextcord", "pycord", "discord.py", "interactions.py", "hikari")
...
class Slashes(commands.Cog):
    ...
    async def stats(
        ...
        platform: str = commands.Param(choices=["pypi", "github"]),
        library: str = commands.Param(choices=LIBRARIES),
    ):
        ...
        if platform == "github":
            ...
            embed1 = disnake.Embed(
                title=f"GitHub {library.capitalize()} Statistics",
            ...
            try:
                ...
                await inter.send(
                    "The pypi command is not working right now."
                )
